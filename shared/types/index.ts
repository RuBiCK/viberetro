...
export interface SocketEvents {
  ...
  'typing:stop': (data: { cardId: string }) => void;
  ...
  'user:reconnected': (data: { userId: string }) => void;
  'cursor:updated': (data: { userId: string; position: { x: number; y: number } }) => void;
  'typing:broadcast': (data: { userId: string; cardId: string; isTyping: boolean }) => void;
  ...
  'session:archived': (data: { sessionId: string; status: SessionStatus }) => void;
