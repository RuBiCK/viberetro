...
export default function Board({ canVote = false, canDrag = false, showBlurred = false, isVoteStage = false, canAddCards = true }: BoardProps) {
  ...
  const columnCount = session.settings.columns.length;
